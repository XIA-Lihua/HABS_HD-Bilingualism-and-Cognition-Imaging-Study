...
efa_data_all = subset(HABS_data_z, select=c("01_L_bankssts_thickavg", "01_L_caudalanteriorcingulate_thickavg",
  "01_L_caudalmiddlefrontal_thickavg", "01_L_cuneus_thickavg",
  "01_L_entorhinal_thickavg", "01_L_fusiform_thickavg",
  "01_L_inferiorparietal_thickavg", "01_L_inferiortemporal_thickavg",
  "01_L_isthmuscingulate_thickavg", "01_L_lateraloccipital_thickavg",
...
efa_data_all <- data.frame(lapply(efa_data_all, function(x) as.numeric(as.character(x))))
```

```{r}
psych::fa.parallel(efa_data_all, fa = "pc")
#### Parallel analysis suggests that the number of components =  7 

# Run PCA
pca_result <- psych::principal(efa_data_all, nfactors = 7, rotate = "oblimin")
# View results
...
```{r}
seven_factor_efa_fit = efa(data = efa_data_all, nfactors=7, missing="fiml", rotation = "oblimin")
summary(seven_factor_efa_fit, fit.measures = TRUE, standardized = TRUE)
```

```{r}
### Select the EF_realted ROIs 
HABS_data_z = subset(HABS_HD_7_Imaging_cross_sectional, select=c("01_L_rostralmiddlefrontal_thickavg","01_R_rostralmiddlefrontal_thickavg",
  ...
  "01_L_insula_thickavg","01_R_insula_thickavg",'Med_ID','Visit_ID'))
HABS_data_z$Med_ID<-as.factor(HABS_data_z$Med_ID)
HABS_data_z$Visit_ID<-as.factor(HABS_data_z$Visit_ID)
HABS_data_z <- HABS_data_z  # make a copy
HABS_data_z[sapply(HABS_data_z, is.numeric)] <- scale(HABS_data_z[sapply(HABS_data_z, is.numeric)])
## create a z-scored dataset for cognitive measures
efa_data_EF = subset(HABS_data_z, select=c("01_L_rostralmiddlefrontal_thickavg","01_R_rostralmiddlefrontal_thickavg",
  "01_L_caudalmiddlefrontal_thickavg","01_R_caudalmiddlefrontal_thickavg",
  "01_L_rostralanteriorcingulate_thickavg","01_R_rostralanteriorcingulate_thickavg",
  "01_L_caudalanteriorcingulate_thickavg","01_R_caudalanteriorcingulate_thickavg",
  "01_L_parsopercularis_thickavg","01_R_parsopercularis_thickavg",
...
efa_data_EF <- data.frame(lapply(efa_data_EF, function(x) as.numeric(as.character(x))))
psych::fa.parallel(efa_data_EF, fa = "pc")
#### Parallel analysis suggests that the number of components =  2 
```
```{r}
# Run PCA
pca_result <- psych::principal(efa_data_EF, nfactors = 2, rotate = "oblimin")
# View results
print(pca_result, digits = 2, cutoff = 0.3)
pca_result$Vaccounted
```
```{r}
two_factor_efa_fit = efa(data = efa_data_EF, nfactors=2, missing="fiml", rotation = "oblimin")
summary(two_factor_efa_fit, fit.measures = TRUE, standardized = TRUE)
```

```{r}
### Select the memory-related ROIs 
...
HABS_data_z[sapply(HABS_data_z, is.numeric)] <- scale(HABS_data_z[sapply(HABS_data_z, is.numeric)])
## create a z-scored dataset for cognitive measures
efa_data_memory = subset(HABS_data_z, select=c( "01_L_entorhinal_thickavg","01_R_entorhinal_thickavg",
  "01_L_parahippocampal_thickavg","01_R_parahippocampal_thickavg",
  "01_L_fusiform_thickavg","01_R_fusiform_thickavg",
  "01_L_inferiortemporal_thickavg","01_R_inferiortemporal_thickavg",
  "01_L_temporalpole_thickavg","01_R_temporalpole_thickavg")) 
efa_data_memory <- data.frame(lapply(efa_data_memory, function(x) as.numeric(as.character(x))))
psych::fa.parallel(efa_data_memory, fa = "pc")
#### Parallel analysis suggests that the number of components =  2 
```
```{r}
# Run PCA
pca_result <- psych::principal(efa_data_memory, nfactors = 2, rotate = "oblimin")
# View results
print(pca_result, digits = 2, cutoff = 0.3)
pca_result$Vaccounted
```
```{r}
two_factor_efa_fit = efa(data = efa_data_memory, nfactors=2, missing="fiml", rotation = "oblimin")
summary(two_factor_efa_fit, fit.measures = TRUE, standardized = TRUE)
```

```{r}
### combined EF+ Memory ROIs
...
```{r}
### Select the EF_realted ROIs 
HABS_data_z = subset(HABS_HD_7_Imaging_longitudinal, select=c("01_L_rostralmiddlefrontal_thickavg","01_R_rostralmiddlefrontal_thickavg",
  "01_L_caudalmiddlefrontal_thickavg","01_R_caudalmiddlefrontal_thickavg",
  "01_L_rostralanteriorcingulate_thickavg","01_R_rostralanteriorcingulate_thickavg",
  "01_L_caudalanteriorcingulate_thickavg","01_R_caudalanteriorcingulate_thickavg",
  "01_L_parsopercularis_thickavg","01_R_parsopercularis_thickavg",
...
```{r}
### Select the memory-related ROIs 
HABS_data_z = subset(HABS_HD_7_Imaging_longitudinal, select=c( "01_L_entorhinal_thickavg","01_R_entorhinal_thickavg",
  "01_L_parahippocampal_thickavg","01_R_parahippocampal_thickavg",
  "01_L_fusiform_thickavg","01_R_fusiform_thickavg",
  "01_L_inferiortemporal_thickavg","01_R_inferiortemporal_thickavg",
  "01_L_temporalpole_thickavg","01_R_temporalpole_thickavg",'Med_ID','Visit_ID'))
